...
public:
	...
	/// \return If the function succeeds, the return value is IZoomVideoSDKUser object vector.
    ...
    /// \return True indicates that current device supports it, 
