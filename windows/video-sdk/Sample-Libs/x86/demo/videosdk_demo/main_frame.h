...
public:
	...
	void CreateShareSelectAppsWnd();
	void CreateEmojiBarWnd();
	void CreateMorePopWnd();
	void CreateBulletScreenWnd();
	void CreateStopShareWnd();
	void CreateChatContentWnd();
	void CreateTurnPageWnd();
	void CreateMessageTipWnd();
	void CreateLowerThirdsInfoWnd();	
	void CreateFeedBackLaunchWnd();
	void CreateFeedBackSubmitWnd();
	void CreateStatisticsWnd();
	void InitVideoSDK();
	void UninitVideoSDK();
	...
	void ShowShareSelectAppsWnd(bool show, RECT rc = { 0 });
	void ShowEmojiBarWnd(bool show, RECT rc = { 0 });
	void ShowMorePopWnd(bool show, RECT rc = { 0 });
	...
	void ShowShareToolBarWnd(bool show, bool isCameraShare = false);
	void ShowStatisticsWnd();	
	void ShowFeedBackLaunchWnd(bool show, RECT rc = { 0 });
	void ShowFeedBackSubmitWnd(bool show);
	void ShowFeedBackTipsWnd(bool show, RECT rc = { 0 });
	void ShowUserEmoji(IZoomVideoSDKUser* pUser, std::wstring reaction_type,bool is_need_check = true);
	...
	void ShowGalleryMorePopWnd(bool show, POINT pt = { 0 });
	void ShowControlCameraTipButton(bool show);
	IZoomVideoSDKUser* GetCameraControlRequester();
	void ShowControlCameraPopWnd(bool show, POINT pt = { 0 });
	void ShowTopTipWnd(bool show, wstring error_text = _T(""));
	void UpdateGalleryMoreWndUIForCameraControl(bool isApproved);
...
public:
	...
	virtual void onRemoteControlStatus(IZoomVideoSDKUser* pUser, ZoomVideoSDKRemoteControlStatus status) {}
	virtual void onRemoteControlRequestReceived(IZoomVideoSDKUser* pUser, IZoomVideoSDKRemoteControlRequestHandler* pRemoteControlRequestHandler) {}
