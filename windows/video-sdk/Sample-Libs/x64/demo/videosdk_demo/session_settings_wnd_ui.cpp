...
void CSessionSettingsWndUI::ShowStatisticsWnd()
{
	CMainFrame::GetInstance().ShowStatisticsWnd();
}
...
void CSessionSettingsWndUI::DoShowStatisticsClick()
{
	ShowStatisticsWnd();
}
